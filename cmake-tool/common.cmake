...
function(SetSeL4Start target)
    if(ClangGccToolchain)
        set_property(TARGET ${target} APPEND_STRING PROPERTY LINK_FLAGS " --force-link _sel4_start -Wl,-e_sel4_start ")
    else()
...
function(DeclareRootserver rootservername)
    ...
    if(ClangGccToolchain)
        set_property(TARGET ${rootservername} APPEND_STRING PROPERTY LINK_FLAGS " -Wl,-T${real_list}/tls_rootserver.lds ")
    else()
