...
add_custom_command(
  PRE_BUILD TARGET nanopb COMMAND ${CMAKE_COMMAND} -E copy_directory ARGS
                                  ${NANOPB_GENERATOR_SOURCE_DIR} ${GENERATOR_PATH}
  BYPRODUCTS ${NANOPB_GENERATOR_EXECUTABLE} ${GENERATOR_CORE_SRC} VERBATIM)
...
function(SEL4_GENERATE_PROTOBUF SRCS HDRS)
  ...
  foreach(FIL ${NANOPB_GENERATE_CPP_UNPARSED_ARGUMENTS})
    ...
    add_custom_command(
      ...
      COMMAND
        ${PROTOBUF_PROTOC_EXECUTABLE} ARGS -I${GENERATOR_PATH} -I${GENERATOR_CORE_DIR}
      ...
      DEPENDS ${ABS_FIL} ${GENERATOR_CORE_SRC} ${GENERATOR_CORE_PYTHON_SRC} ${NANOPB_OPTIONS_FILE}
              ${NANOPB_DEPENDS}
