...
function(GenerateSimulateScript)
    ...
    elseif(KernelPlatformQEMUArmVirt)
        ...
        if(NOT DEFINED QEMU_GIC_VERSION)
            set(gic_version "")
        elseif(QEMU_GIC_VERSION EQUAL 2)
            set(gic_version ",gic-version=2")
        elseif(QEMU_GIC_VERSION EQUAL 3)
            set(gic_version ",gic-version=3")
        endif()
        if(KernelArmHypervisorSupport)
            set(sim_machine "virt,virtualization=on,highmem=off,secure=off${gic_version}")
        else()
            set(sim_machine "virt${gic_version}")
        endif()
